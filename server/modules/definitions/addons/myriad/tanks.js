  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, {reload: 1.3, damage: 0.6}]),
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, g.twin, {reload: 1.4, damage: 0.8}]),
              	TYPE: "myriad_multiBullet"
            }
        },
      	{
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.tripleShot, {reload: 1.5, damage: 0.5}]),
              	TYPE: "myriad_multiBullet"
            }
        },
      	{
        ...
        },
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.tripleShot, {reload: 1.5, damage: 0.7}]),
              	TYPE: "myriad_multiBullet"
            }
        },
      	{
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, g.pounder, {reload: 1.6}]),
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.pounder, {damage: 0.7, reload: 1.6}]),
              	TYPE: "myriad_tetraBullet"
            }
        },
      	{
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, {reload: 1.4, damage: 0.9}]),
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, g.twin, {damage: 0.8, reload: 1.8}]),
              	TYPE: "myriad_splitterBullet"
            }
        },
      	{
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, g.pounder, {reload: 1.8}]),
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, {reload: 1.3, damage: 0.8}]),
  	...
  	GUNS: [
      	{
          	...
          	PROPERTIES: {
              	SHOOT_SETTINGS: combineStats([g.basic, {reload: 1.8, damage: 0.7}]),
...
Class.myriad_knight = {
  	...
  	GUNS: weaponArray({
      	...
      	PROPERTIES: {
          	SHOOT_SETTINGS: combineStats([g.basic, {reload: 0.02, damage: 2, range: 0.03, health: 2, pen: 2, speed: 0.05, maxSpeed: 0.05}]),
...
Class.myriad_beetle = {
  	...
  	GUNS: [
    		makeBlimp({ angle: 165, y: -3, delay: 0.5, length: -1.5, width: -0.5, recoil: 0.4 }),
      	makeBlimp({ angle: -165, y: 3, delay: 0.5, length: -1.5, width: -0.5, recoil: 0.4 }),
      	makeBlimp({ angle: 150, y: -2, recoil: 0.3 }),
      	makeBlimp({ angle: -150, y: 2, recoil: 0.3 })
    ]
}
Class.myriad_engine = {
...
Class.myriad_thrasher.TURRETS = weaponArray({
  	POSITION: [17.5, 0, 0, 0, 360, 0],
  	TYPE: ["spikeBody", {FACING_TYPE: ["spin", {speed: 0.5}]}]
}, 4)
// wave 3 misc
...
Class.myriadTesting.UPGRADES_TIER_0 = ["myriad_icicle"]
Class.myriad_basic.UPGRADES_TIER_1 = ["myriad_multiplier", "myriad_signaler", "myriad_blimp", "myriad_missiler"]
		...
		Class.myriad_signaler.UPGRADES_TIER_2 = ["myriad_wifi", "myriad_phone", "myriad_darkWeb"]
				...
				Class.myriad_phone.UPGRADES_TIER_3 = ["myriad_application", "myriad_android", "myriad_bluetooth"]
